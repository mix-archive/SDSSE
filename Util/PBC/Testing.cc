...
int main(int argc, char **argv) {
  ...
  G1 p2(e,
        (const unsigned char
             *)"[15508022087507441644321359794141253286503188141888624922251468"
               "518367693905002583997883676151421358495056468416636012319326088"
               "34381650558011983930152205480, "
               "162426794903089459059163657485909203049527624684632613984369979"
               "812948511813352043323998239353170652927595733566299330078984161"
               "336240682404138940861563814]",
        311, false, 10);
  ...
  G1 p3(
      e,
      (const unsigned char
           *)"\x1d\x9c\x29\xcd\xc7\x2a\xca\x6c\x73\x53\xf9\x59\x92\x78\x39\xe9"
             "\x4e\x2e\x73\x13\xac\x66\xcc\xb2\x15\xfd\x3f\xc1\x61\x51\x89\xf4"
             "\xad\xe6\x57\x5f\x43\xf0\xa8\xc0\xbd\x3e\xc8\xe1\x9f\x86\x96\x92"
             "\x4f\x41\x22\x20\x96\xd3\x9b\xd8\x3c\xd8\xfe\x14\xb6\xf4\x3c\xa8"
             "\x03\x19\xec\xf6\x71\xe1\x03\x92\x9c\x86\x81\xbf\x8d\x5a\xc8\x69"
             "\xff\xac\x18\x41\x34\x57\xfe\x0f\xfe\xfc\xe3\xea\xd8\x0c\x4e\xdb"
             "\x45\x15\x3d\x35\xc0\x4c\x14\x27\xf5\x19\x1e\x03\xd2\x0e\x57\x91"
             "\xb4\x04\x18\x17\x05\x50\xdc\xd4\x80\x23\x90\x19\x98\x5c\xc3\xa6",
      128); // , false, 0 is the default for compressed, base
  p3.dump(stdout, "p3 is               ", 16);
  cout << "p == p3 ? " << ((p == p3) ? "YES" : "NO") << "\n";
  G1 p4(e,
        (const unsigned char
             *)"\x1d\x9c\x29\xcd\xc7\x2a\xca\x6c\x73\x53\xf9\x59\x92\x78\x39"
               "\xe9\x4e\x2e\x73\x13\xac\x66\xcc\xb2\x15\xfd\x3f\xc1\x61\x51"
               "\x89\xf4\xad\xe6\x57\x5f\x43\xf0\xa8\xc0\xbd\x3e\xc8\xe1\x9f"
               "\x86\x96\x92\x4f\x41\x22\x20\x96\xd3\x9b\xd8\x3c\xd8\xfe\x14"
               "\xb6\xf4\x3c\xa8\x00",
        65, true); // 0 is the default base
